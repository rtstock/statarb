...
class find:
    ...
    def findopportunities(self
        ...
        for ticker1 in self.SymbolsList:
            print 'finding opportunities',ticker1
...
##            #        break
    ...
    def setclassdictionaries(self,closepricesfilepath,movingaveragewindow,list_of_tickers = []):
...
if __name__=='__main__':
    list_of_tickers=['AAPL','TSLA','AMZN','MS','BAC','CA','CHD']
    o = find(
