    ...
    def setslopeofdollarizedhedgeratiodataframe(self,
        ...
        for s1 in columns:
            ...
            if not s1 in self.PairDollarizedHedgeRatioDiffDictionary:
                ...
                df_pp = self.PairDollarizedHedgeRatioDiffDictionary[s1]
...
##        self.BetaHedgeRatioDataframe = df_betahr
    ...
    o = find(closepricesfilepath = 'C:\\Batches\\GitStuff\\$work\\closeprices_sample.csv', list_of_tickers=list_of_tickers)#list_of_tickers)
