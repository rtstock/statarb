...
class find:
    ...
    def set_RunningMaxDiffsDictionary(self,RunningMaxDiffsDictionary):
        self._RunningMaxDiffsDictionary = RunningMaxDiffsDictionary
    def get_RunningMaxDiffsDictionary(self):
        return self._RunningMaxDiffsDictionary
    RunningMaxDiffsDictionary = property(get_RunningMaxDiffsDictionary, set_RunningMaxDiffsDictionary)

    def set_RunningMinDiffsDictionary(self,RunningMinDiffsDictionary):
        self._RunningMinDiffsDictionary = RunningMinDiffsDictionary
    def get_RunningMinDiffsDictionary(self):
        return self._RunningMinDiffsDictionary
    RunningMinDiffsDictionary = property(get_RunningMinDiffsDictionary, set_RunningMinDiffsDictionary)
...
##        stop
    ...
    def runbyticker(self,ticker):
        ...
        ticker1 = ticker
        df_dollarized = self.PairDollarizedDiffsDictionary[ticker1]
        df_runningmax = self.RunningMaxDiffsDictionary[ticker]
...
##            #        break
    ...
    def setclassdictionaries(self,closepricesfilepath,movingaveragewindow):
        ...
        for column in columns:
            ...
            df_diff_runningpct = df_diff_prices[columns].sub(df_diff_runningmin[column1],axis=0)
            #df_diff_percentfrommax = df_diff_runningmax[columns].sub(df_diff_prices[columns], axis=0).div(df_diff_runningmax[columns],axis=0)
            df_diff_prices_minus_runningmin = df_diff_prices - df_diff_runningmin
            df_runp = ( df_diff_prices - df_diff_runningmin ) / ( df_diff_runningmax - df_diff_runningmin) 
            print 'df_diff_prices',df_diff_prices
            #print 'df_diff_runningmin',df_diff_runningmin
            print 'df_runp',df_runp.round(3)
            #print 'print df_diff_runningpct', df_diff_runningpct
            stop
            
            df_diff_percentofmax = df_diff_prices[columns].div(df_diff_runningmax[columns], axis=0)
            
        
            print 'df_diff_betweenmaxmin',df_diff_betweenmaxmin
            stop
            #print 'df_diff_runningmax', df_diff_runningmax
            #print 'df_diff_percentofmax', df_diff_percentofmax
            print 'df_diff_runningmin', df_diff_runningmin
            #print 'df_diff_percentofmin', df_diff_percentofmin
            stop
        ...
        self.RunningMaxDiffsDictionary = dict_pairdiff_runningmax
        self.RunningMinDiffsDictionary = dict_pairdiff_runningmin
