...
def stockpricehistorystacked(symbols,fromdate,todate):
    ...
    return df_pivotclose, df_pivotadjclose, df_missing
...
if __name__=='__main__':
    ...
    print symbols
    df_close,df_adjclose,df_missing = stockpricehistorystacked(symbols,'2017-07-01','2017-08-05')
    print df_close
